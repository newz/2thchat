...
while($r = DB::fetch($re)){
	...
	if($uid==$r['uid']){
		...
		$body_onlineex[0] .= '<div id="nzolpro_'.$r['uid'].'_menu" class="nzchatpro" style="display:none;"><img src="'.avatar($r['uid'],'middle',1).'" alt="" onError="this.src=\'uc_server/images/noavatar_middle.gif\';" /><br /><a href="home.php?mod=space&amp;uid='.$r['uid'].'" style="color:'.$r['color'].';" target="_blank" class="nzca" >'.stripslashes($r['nameold']).'</a>'.($config['chat_point']?'<br />'.lang('plugin/th_chat', 'jdj_th_chat_text_php_61').': '.$r['point']:'').($config['namemode']==1?'<br/><span id="nzstatus" class="nzustatus_'.$r['uid'].'">'.$status.'</span>':'').'<div style="text-align:left;padding-left:20px;margin-bottom:7px;"><img src="source/plugin/th_chat/images/av.gif" align="absmiddle" alt="" /> <a href="home.php?mod=spacecp&ac=avatar">'.lang('plugin/th_chat', 'jdj_th_chat_text_php_36').'</a></div></div>';
	}else{
		...
		$body_onlineex[$r['groupid']] .= '<div id="nzolpro_'.$r['uid'].'_menu" class="nzchatpro" style="display:none;"><img src="'.avatar($r['uid'],'middle',1).'" alt="" onError="this.src=\'uc_server/images/noavatar_middle.gif\';" /><br /><a href="home.php?mod=space&amp;uid='.$r['uid'].'" style="color:'.$r['color'].';" target="_blank" class="nzca" >'.stripslashes($r['nameold']).'</a>'.($config['chat_point']?'<br />'.lang('plugin/th_chat', 'jdj_th_chat_text_php_61').': '.$r['point']:'').($config['namemode']==1?'<br/><span id="nzstatus" class="nzustatus_'.$r['uid'].'">'.$status.'</span>':'').'<div style="text-align:left;padding-left:20px;margin-bottom:7px;"> <img src="source/plugin/th_chat/images/useron.gif" align="absmiddle" alt="" /> <a href="javascript:void(0);" onClick="nzTouid('.$r['uid'].')">'.lang('plugin/th_chat', 'jdj_th_chat_text_php_01').'</a><br /><img src="source/plugin/th_chat/images/addbuddy.gif" align="absmiddle" alt="" /> <a href="home.php?mod=spacecp&amp;ac=friend&amp;op=add&amp;uid='.$r['uid'].'&amp;handlekey=addfriendhk_'.$r['uid'].'" id="a_friend_li_'.$r['uid'].'" onClick="showWindow(this.id, this.href, \'get\', 0);">'.lang('plugin/th_chat', 'jdj_th_chat_text_php_40').'</a><br /><img src="source/plugin/th_chat/images/pmto.gif" align="absmiddle" alt="" /> <a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_'.$r['uid'].'&amp;touid='.$r['uid'].'&amp;pmid=0&amp;daterange=2" onClick="showWindow(\'showMsgBox\', this.href, \'get\', 0)" id="a_sendpm_'.$r['uid'].'" style="color:#333333;" class="xi2">'.lang('plugin/th_chat', 'jdj_th_chat_text_php_49').'</a></div>';
	}
