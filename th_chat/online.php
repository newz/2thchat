...
while($r = DB::fetch($re) OR $r = DB::fetch($re2)){
	...
	$ucolor = get_effective_colorinfo($r['uid'],$r['groupid'],$r['color']);
	...
	if($time-$r['lastactivity']>$timeout2)
	{
		...
		<span id="nzolpro_'.$r['uid'].'" '.($is_banned?'style="font-style: oblique;"':'').' onMouseOver="showMenu(this.id)"><a href="home.php?mod=space&amp;uid='.$r['uid'].'" target="_blank" style="margin-left:-3px;" class="nzca" ><span style="'.$ucolor.'"><span class="nzuname_'.$r['uid'].'">'.$r['name'].'</span></span></a></span></p></li>';
		$body_onlineex[$r['groupid']] .= '<div id="nzolpro_'.$r['uid'].'_menu" class="nzchatpro" style="display:none;"><img src="'.avatar($r['uid'],'middle',1).'" alt="" onError="this.src=\'uc_server/images/noavatar_middle.gif\';" /><br /><a href="home.php?mod=space&amp;uid='.$r['uid'].'" style="'.$ucolor.'" target="_blank" class="nzca" >'.stripslashes($r['nameold']).'</a>'.($config['chat_point']?'<br />'.lang('plugin/th_chat', 'jdj_th_chat_text_php_61').': '.$r['point']:'').($config['namemode']==1?'<br/><span id="nzstatus" class="nzustatus_'.$r['uid'].'">'.$status.'</span>':'').'<div style="text-align:left;padding-left:20px;margin-bottom:7px;"><img src="source/plugin/th_chat/images/avatar.png" align="absmiddle" alt="" /> <a href="home.php?mod=spacecp&ac=avatar">'.lang('plugin/th_chat', 'jdj_th_chat_text_php_36').'</a><br><img src="source/plugin/th_chat/images/settings.png" align="absmiddle" alt="" /> <a href="javascript:void(0);" onclick="showWindow(\'th_chat_setting\', \'plugin.php?id=th_chat:setting\');return false;">ตั้งค่าห้องแชท</a></div></div>';
	}else{
